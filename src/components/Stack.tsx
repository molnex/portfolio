...
export default function Stack() {
  ...
  const technologies = [
    { name: "React", category: t.stack.categories.ecosystem, icon: <SiReact className="w-6 h-6 text-[#61DAFB]" /> },
    { name: "TypeScript", category: t.stack.categories.language, icon: <SiTypescript className="w-6 h-6 text-[#3178C6]" /> },
    { name: "Tailwind CSS", category: t.stack.categories.styling, icon: <SiTailwindcss className="w-6 h-6 text-[#38BDF8]" /> },
    { name: "JavaScript", category: t.stack.categories.language, icon: <SiJavascript className="w-6 h-6 text-[#F7DF1E]" /> },
    { name: "Framer Motion", category: t.stack.categories.animation, icon: <SiFramer className="w-6 h-6 text-primary" /> },
    { name: "WordPress", category: t.stack.categories.commercial, icon: <SiWordpress className="w-6 h-6 text-[#21759B]" /> },
  ];
    ...
    <section id="stack" className="relative w-full py-32 md:py-48 px-6 md:px-12 lg:px-24 bg-surface border-t border-black/5 dark:border-white/5">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-16 md:gap-24">
        ...
        <div className="md:w-1/3 flex flex-col">
          ...
          >
            {t.stack.titleLine1}<br/>{t.stack.titleLine2}
          </motion.h2>
          <motion.p 
            initial={{ opacity: 0 }}
