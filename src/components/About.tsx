...
export default function About() {
  ...
  return (
    <section className="relative w-full py-32 md:py-48 px-6 md:px-12 lg:px-24 bg-surface flex justify-center border-t border-white/5">
      <div className="max-w-7xl w-full flex flex-col">
        
        {/* Масивна текстова заява */}
        <motion.h2
          initial={{ opacity: 0, y: 40 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true, margin: "-100px" }}
          transition={{ duration: 1.2, ease: easeOutExpo }}
          className="text-3xl md:text-5xl lg:text-6xl font-display font-medium leading-[1.15] tracking-tight text-muted max-w-5xl"
        >
